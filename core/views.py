...
def check_version(request):
    return Response({
        "version_minima": "1.0.1", # Incrementa esto cuando saques un nuevo APK
        "url_descarga": "https://drive.google.com/file/d/1dD1YVadciwfnXcT8MwkGk8DLPauwoyVc/view?usp=sharing",
